import { useMaxModeAnimation } from '../animations/useSiteAnimations'

export default function MaxModeSection() {
  const containerRef = useMaxModeAnimation()

  return (
    <section id="max-mode" style={{ background: 'var(--bg-alt)' }} ref={containerRef}>
      <div className="container spotlight">
        <div>
          <span className="spot-pill">⚡ Max Budget Mode</span>
          <h2 className="spotlight-h2">One switch, smarter Sonnet.</h2>
          <p className="spotlight-p">Got a hard problem? Flip Max Budget Mode and Sonnet thinks as long as it wants before answering. It costs more of your subscription quota, but you get better answers on the things that actually matter.</p>
        ...
        <div className="spot-shot will-change-transform">
          <img
